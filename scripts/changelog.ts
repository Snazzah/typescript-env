...
arr = futureChangelog
  ...
  .map((line) =>
    line.startsWith('[Unreleased]')
      ? `[Unreleased]: https://github.com/Snazzah/typescript-env/compare/v${currentVersion}...HEAD`
      : line
  );
...
const lastLine = `[${currentVersion}]: https://github.com/Snazzah/typescript-env/compare/v${lastVersion}...v${currentVersion}`;
